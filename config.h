...
static Key keys[] = {
  ...
  //{ MODKEY|ControlMask|ShfitMask, XK_space,  setlayout,      {0} },
	...
	{ MODKEY|ControlMask,           XK_z,      incrgaps,       {.i = +2 } },
	{ MODKEY|ControlMask|ShiftMask, XK_z,      incrgaps,       {.i = -2 } },
  // Basic programs
